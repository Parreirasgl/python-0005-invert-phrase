...
def invert_list(list_word):
    """Invert items in list. To do this, it does a for loop through the length of the list.
    Then save the last value of the list; then deletes last value;
    then insert last value in the right place
    Inverte itens na lista. Para isso, faz um for loop pelo comprimento da lista.
